  ...
  <div class="header">
	...
	<div class="sidebar1">
		<div class="user-profile">
			<P> Welcome,</br> <span class="influence"><?php echo $name?> <span></p>
		</div>
		<div class="creator-project">Current Project:</br><span class="creator-project-anme"><?php echo $projectName?></span></div>	
...
?>
					<li><a href="/php/search2.php?q=<?php echo $query?>&searchType=Contributor&s=promotion&order=DESC&rows=20">Influence</a></li>
					<li><a href="/php/search2.php?q=<?php echo $query?>&searchType=Contributor&s=contribute_money&order=DESC&rows=20">Money</a></li>
					<li><a href="/php/search2.php?q=<?php echo $query?>&searchType=Contributor&s=contribute_volunteer_hours&order=DESC&rows=20">Hours</a></li>
					<li><a href="/php/search2.php?q=<?php echo $query?>&searchType=Contributor&s=contribute_supplies&order=DESC&rows=20">Supplies</a></li>
					
<?php
				}
				else{
?>
					<li><a href="/php/search2.php?q=<?php echo $query?>&searchType=Project&s=influence&order=DESC&rows=20">Influence</a></li>
					<li><a href="/php/search2.php?q=<?php echo $query?>&searchType=Project&s=success&order=DESC&rows=20">Success</a></li>
<?php
				}
			}
?>
...
?>
	...
	<div class="influential-project" align="center">Contributors interested in your project</div>
<?php
	$solr = new Apache_Solr_Service( 'localhost', '8983', '/solr/contributor1' );
